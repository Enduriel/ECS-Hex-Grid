...
namespace MyNamespace
{
    ...
    public partial struct HexGridInteractionSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            Debug.DrawLine(userMouseInfo.Ray.Origin, userMouseInfo.Ray.Origin + userMouseInfo.Ray.Displacement * 1000, Color.red, 100f);
            ...
            if (collisionWorld.CastRay(test, out RaycastHit hit))
            {
                ...
                Debug.DrawLine(localTransform.ValueRO.Position, localTransform.ValueRO.Position + new float3(0, 1, 0),
                    Color.black, 100f);
                Debug.DrawLine(HexHelpers.GetWorldPosition(buffer[hexIdx].Value.Coords, localTransform.ValueRO), HexHelpers.GetWorldPosition(buffer[hexIdx].Value.Coords, localTransform.ValueRO) + new float3(0,1,0), Color.blue, 100f);
