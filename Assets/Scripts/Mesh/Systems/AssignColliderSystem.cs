...
namespace MyNamespace
{
    ...
    public partial struct AssignColliderSystem : ISystem
    {
        ...
        public void OnCreate(ref SystemState state)
        {
            ...
            _query = SystemAPI.QueryBuilder().WithAll<ColliderOutdatedTag, MaterialMeshInfo, SyncColliderWithMeshTag>().Build();
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            foreach (var materialMeshInfo in SystemAPI.Query<RefRO<MaterialMeshInfo>>().WithAll<ColliderOutdatedTag, SyncColliderWithMeshTag>())
            {
